...
public static class YuanQiSystem
{
    ...
    public const string SecondaryEnergyCounterScenePath =
        "res://GuZhenRenPersonal/scenes/ui/nodes/GuZhenRen_energy_counter2.tscn";

    public const string LargeIconPath =
        "res://GuZhenRenPersonal/images/characters/energy_big.png";

    public const string SmallIconPath =
        "res://GuZhenRenPersonal/images/characters/energy_text.png";
    ...
    public static SecondaryResourceDefinition Definition { get; private set; } =
        new(
            ...
            titleKey: "GU_ZHEN_REN_PERSONAL_SECONDARY_RESOURCE_YUAN_QI.title",
            descriptionKey: "GU_ZHEN_REN_PERSONAL_SECONDARY_RESOURCE_YUAN_QI.description",
