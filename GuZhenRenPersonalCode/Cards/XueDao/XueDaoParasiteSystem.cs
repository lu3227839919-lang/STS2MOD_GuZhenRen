        ...
        string? entry = kind switch
        {
            ParasiteKind.BloodQi => host.Type switch
            {
                CardType.Attack when
                    ...
                    "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_BLOOD_QI_ATTACK_ALL.cardText",
                CardType.Attack =>
                    "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_BLOOD_QI_ATTACK.cardText",
                CardType.Skill =>
                    "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_BLOOD_QI_SKILL.cardText",
                _ =>
                    "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_BLOOD_QI_POWER.cardText",
            },
            ParasiteKind.BloodMoon => stage switch
            {
                <= 0 => "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_CRESCENT_MOON.cardText",
                1 => "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_WAXING_MOON.cardText",
                _ => "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_FULL_MOON.cardText",
            },
            ParasiteKind.BloodFetus => host.Type switch
            {
                CardType.Attack when
                    host.TargetType == TargetType.AllEnemies =>
                    "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_BLOOD_FETUS_ATTACK_ALL.cardText",
                CardType.Attack =>
                    "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_BLOOD_FETUS_ATTACK.cardText",
                CardType.Skill =>
                    "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_BLOOD_FETUS_SKILL.cardText",
                _ =>
                    "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_BLOOD_FETUS_POWER.cardText",
            },
            _ => null,
        };
    ...
    private static string GetHostTypeDisplay(CardModel host)
    {
        string entry = host.Type switch
        {
            CardType.Attack when host.TargetType == TargetType.AllEnemies =>
                "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_HOST_ATTACK_ALL",
            CardType.Attack => "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_HOST_ATTACK",
            CardType.Skill => "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_HOST_SKILL",
            CardType.Power => "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_HOST_POWER",
            _ => "GU_ZHEN_REN_PERSONAL_CARD_PARASITE_HOST_OTHER",
        };
